...
public class DriverFactory {
	...
	public static WebDriver createWebDriverInstance(String browserName, String platform)
	...
	private static WebDriver getWebDriverFromConfiguration(DriverType driverType, String platform)
			throws MalformedURLException {
		WebDriver driver;
	...
	private static void configureWebDriver(WebDriver driver) {
		driver.manage().timeouts()
				.implicitlyWait(PropertyReader.getImplicitWaitTimeOut(), TimeUnit.SECONDS);
		driver.manage().timeouts()
				.setScriptTimeout(PropertyReader.getImplicitWaitTimeOut(), TimeUnit.SECONDS);
